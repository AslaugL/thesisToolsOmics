...
createPCA <- function(df, principal_components = c(1,2), plots = 'scores', cutoff = NULL, features = NULL) {
  ...
  #Which plot to plot?
  if(plots == 'scores'){
    plot <- plotPCAscores(plot_subjects, prc = percentages[principal_components])
